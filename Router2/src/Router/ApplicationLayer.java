...
public class ApplicationLayer extends JFrame implements BaseLayer {
   ...
   static NILayer m_PacketDriverLayer_1;
   ...
   static NILayer m_PacketDriverLayer_2;
   ...
   private static LayerManager m_LayerMgr2 = new LayerManager();


   public static void main(String[] args) {

      m_PacketDriverLayer_1 = new NILayer("NI_1");
      m_EthernetLayer_1 = new EthernetLayer("Ethernet_1");
      m_ARPLayer_1 = new ARPLayer("ARP_1");
      m_IPLayer_1 = new IPLayer("IP_1");
      m_ApplicationLayer = new ApplicationLayer("DLG");

      m_PacketDriverLayer_2 = new NILayer("NI_2");
      m_EthernetLayer_2 = new EthernetLayer("Ethernet_2");
      m_ARPLayer_2 = new ARPLayer("ARP_2");
      m_IPLayer_2 = new IPLayer("IP_2");

      m_LayerMgr.AddLayer(m_EthernetLayer_1);
      m_LayerMgr.AddLayer(m_PacketDriverLayer_1);
      m_LayerMgr.AddLayer(m_IPLayer_1);
      m_LayerMgr.AddLayer(m_EthernetLayer_1);
      m_LayerMgr.AddLayer(m_IPLayer_1);
      m_LayerMgr.AddLayer(m_ARPLayer_1);
      m_LayerMgr.AddLayer(m_ApplicationLayer);

      m_LayerMgr2.AddLayer(m_EthernetLayer_2);
      m_LayerMgr2.AddLayer(m_PacketDriverLayer_2);
      m_LayerMgr2.AddLayer(m_IPLayer_2);
      m_LayerMgr2.AddLayer(m_EthernetLayer_2);
      m_LayerMgr2.AddLayer(m_IPLayer_2);
      m_LayerMgr2.AddLayer(m_ARPLayer_2);
      m_LayerMgr2.AddLayer(m_ApplicationLayer);
      m_LayerMgr.ConnectLayers(" NI_1 ( *Ethernet_1 ( *ARP_1 ( *IP_1 ( *DLG ) ) ) *Ethernet_1 ( *IP_1 ( *DLG ) ) )  ");
      m_LayerMgr2.ConnectLayers(" NI_2 ( *Ethernet_2 ( *ARP_2 ( *IP_2 ( *DLG ) ) ) *Ethernet_2 ( *IP_2 ( *DLG ) ) ) ");
         ...
         while (true) {
            ...
            for (int i = 0; i < m_ARPLayer_1.ARPCacheTableCount; i++) {
               ...
               if (!temp_ip.equals("0.0.0.0")) {
                  ...
                  System.out.println(byte2IP(ARP_IP) + "  " + Mac_byte + "  " + ARP_Check);
               }
      ...
      public void actionPerformed(ActionEvent e) {
         ...
         if (e.getSource() == myAddressSet_btn) {
            ...
            if (Destination.getText().length() < 12) {
               ...
               JOptionPane.showMessageDialog(null, "12자리 Gateway IP 주소를 입력해주세요.s", "WARNING_MESSAGE",
                     JOptionPane.WARNING_MESSAGE);
               ...
               JOptionPane.showMessageDialog(null, "Flag에서 Gateway와 Host를 동시에 선택할 수 없습니다.",
            ...
            if (ProxyARPDevice.getText().length() < 1 && ProxyARPIP.getText().length() < 12
               ...
               JOptionPane.showMessageDialog(null, "Proxy ARP Entry의 Device Name를 입력해주세요.",
                     "WARNING_MESSAGE", JOptionPane.WARNING_MESSAGE);
            } else if (ProxyARPIP.getText().length() < 12) {
               JOptionPane.showMessageDialog(null, "Proxy ARP Entry의 IP 주소를 12자리 입력해주세요.",
                     "WARNING_MESSAGE", JOptionPane.WARNING_MESSAGE);
            } else if (ProxyARPMac.getText().length() < 12) {
               JOptionPane.showMessageDialog(null, "Proxy ARP Entry의 MAC 주소를 12자리 입력해주세요.",
                     "WARNING_MESSAGE", JOptionPane.WARNING_MESSAGE);
            } else {
   ...
   public ApplicationLayer(String pName) {
      pLayerName = pName;
      setTitle("2조 강서연,김예윤,심승민,유혜경,이경식,조현아");
      ...
      ARPcachePanel.setBounds(23, 346, 420, 247);
      ...
      AddressPanel.setBounds(479, 20, 350, 110);
      ...
      AddressPanel2.setBounds(479, 140, 350, 110);
      ...
      StaticRoutingPanel.setBounds(23, 10, 420, 326);
      ...
      StaticRoutingAdd_btn.setBounds(296, 240, 100, 30);
      ...
      StaticRoutingDelete_btn.setBounds(296, 280, 100, 30);
      ...
      label_7.setBounds(20, 175, 70, 20);
      ...
      label_8.setBounds(20, 205, 70, 20);
      ...
      label_9.setBounds(20, 231, 70, 20);
      ...
      Destination.setBounds(105, 175, 160, 20);
      ...
      Netmask.setBounds(105, 205, 160, 20);
      ...
      Gateway.setBounds(105, 235, 160, 20);
      ...
      CheckBoxGateway.setBounds(143, 264, 80, 20);
      ...
      label_11.setBounds(20, 290, 70, 20);
      ...
      interface_box.setBounds(105, 290, 160, 20);
      ...
      CheckBoxHost.setEnabled(false);
      CheckBoxHost.setBounds(226, 264, 62, 20);
      StaticRoutingPanel.add(CheckBoxHost);

      JPanel ProxyARPpanel = new JPanel();
      ProxyARPpanel.setBounds(479, 275, 350, 318);
      ...
      ProxyARPeditorPanel.setBounds(12, 25, 319, 135);
      ProxyARPpanel.add(ProxyARPeditorPanel);

      Proxylist = new List();
      Proxylist.setBounds(0, 0, 319, 125);
      ProxyARPeditorPanel.add(Proxylist);

      ProxyARPDelete_btn = new JButton("Delete");
      ProxyARPDelete_btn.setEnabled(false);
      ProxyARPDelete_btn.setBounds(209, 261, 100, 30);
      ...
      ProxyARPDevice.setBounds(90, 170, 219, 20);
      ...
      ProxyARPMac.setBounds(90, 230, 219, 20);
      ...
      label_6.setBounds(12, 170, 70, 20);
